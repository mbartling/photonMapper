...
#time ./ray -w 400 -r 4 -x 4 -f 0.5 -p 100000 -L cubemaps/cubemap_autumn/autumn_negative_x.png -T cubemaps/cubemap_autumn/autumn_positive_y.png -F cubemaps/cubemap_autumn/autumn_positive_z.png -D cubemaps/cubemap_autumn/autumn_negative_y.png -R cubemaps/cubemap_autumn/autumn_positive_x.png -B cubemaps/cubemap_autumn/autumn_negative_z.png wineglasses.ray out.bmp

#time ./ray -w 400 -r 5 -f 0.5 -p 100000 wineglasses.ray out.bmp

#time ./ray -w 512 -r 4 -f 0.1 -p 1000000 easy3a.ray out_easy3a.bmp

#time ./ray -w 400 -r 4 -x 2 -f 0.5 -p 1000000 -L cubemaps/cubemap_autumn/autumn_negative_x.png -T cubemaps/cubemap_autumn/autumn_positive_y.png -F cubemaps/cubemap_autumn/autumn_positive_z.png -D cubemaps/cubemap_autumn/autumn_negative_y.png -R cubemaps/cubemap_autumn/autumn_positive_x.png -B cubemaps/cubemap_autumn/autumn_negative_z.png wineglasses.ray out.bmp

#time ./ray -w 1024 -r 4  -x 2 -d -f 0.5 -p 1000000 -L cubemaps/cubemap_autumn/autumn_negative_x.png -T cubemaps/cubemap_autumn/autumn_positive_y.png -F cubemaps/cubemap_autumn/autumn_positive_z.png -D cubemaps/cubemap_autumn/autumn_negative_y.png -R cubemaps/cubemap_autumn/autumn_positive_x.png -B cubemaps/cubemap_autumn/autumn_negative_z.png buddha.ray out.bmp

#time ./ray -w 512 -r 4 -f 0.1 -p 1000000 easy3a.ray out_easy3a_third.bmp
